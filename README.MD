...
This PHP-based application allows users to track and view their electricity and water consumption. It includes a login system, database management with MySQL (using phpMyAdmin), and personalized consumption tips based on usage levels.

---

## Project Structure
## All the below values are strictly optional
### Used Database Setup
- **Database Name**: `project5`
- Tables: `users`, `consumption`
